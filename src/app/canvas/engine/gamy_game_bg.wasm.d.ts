...
export const main: (a: number, b: number) => any;
...
export const closure103_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure99_externref_shim: (a: number, b: number, c: any) => void;
export const closure1304_externref_shim: (a: number, b: number, c: any) => void;
export const closure2667_externref_shim: (a: number, b: number, c: any) => void;
export const closure2663_externref_shim: (a: number, b: number, c: any) => void;
export const closure2661_externref_shim: (a: number, b: number, c: any) => void;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h95c47200d438bcac: (a: number, b: number) => void;
export const closure2729_externref_shim: (a: number, b: number, c: any) => void;
export const closure2754_externref_shim: (a: number, b: number, c: any, d: any) => void;
