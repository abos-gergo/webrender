...
export const closure113_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure1302_externref_shim: (a: number, b: number, c: any) => void;
export const closure2620_externref_shim: (a: number, b: number, c: any) => void;
export const closure2614_externref_shim: (a: number, b: number, c: any) => void;
export const closure2616_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h45d49061bb1be79d: (a: number, b: number) => void;
export const closure2612_externref_shim: (a: number, b: number, c: any) => void;
export const closure2618_externref_shim: (a: number, b: number, c: any) => void;
export const closure2725_externref_shim: (a: number, b: number, c: any) => void;
