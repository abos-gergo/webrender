...
use post_processing::color::ShadowRenderer;
...
impl Renderer {
    pub async fn new(window: Arc<Window>) -> Self {
        ...
        let shadow_renderer = ShadowRenderer::new(&device, &model_bind_group_layout);
        ...
        let scene_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::TextureView(&shadow_renderer.texture.view),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
